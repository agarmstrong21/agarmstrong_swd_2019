...
Name of Class: MachineLearning
Class Description: This is a class that stores the MachineLearning Functions. Hamming_Distance, Euclidean_Distance,
 Cosine_Similarity, and K Nearest Neighbor
 */

// Importing Node, File, FileNotFoundException, Array, and * to properly use Machine Learning.
...
/**This is a class that stores the MachineLearning Functions. Hamming_Distance, Euclidean_Distance, Cosine_Similarity, and K Nearest Neighbor*/
class MachineLearning {
    ...
    // Hamming_Distance Method. Takes in two binary strings and sends back the Hamming Distance
    ...
    // Euclidean_Distance Method. Takes in two double arrays, and sends back the Euclidean Distance
    ...
    // kNearest function that takes in a file, a double array, and a k to find the k nearest values.
    String kNearest(String file, double[] a, int k) throws FileNotFoundException  {
        ...
        // Scans and stores all lines of the text files.
        ...
        //Return statement depending on if which numClass is greater. If equal, send back class1
    ...
    private static class kNearestHelper implements Comparable{
        ...
        kNearestHelper(int clusterClass, double eDist) {
    ...
    // The code below this is MachineLearning_Hard, I kept it in here for reference later on.
